...
export default {
  ...
  cartDialog: {
    title: 'Carrito',
    message: 'maneja la lógica del carrito'
  },
  addDialog: {
    title: 'Agregar al carrito',
    message: 'agrega el pack completo al carrito sin personalizar'
  },
  selectDialog: {
    title: 'Elegir items',
    message: 'abre popup para elegir items a agregar al carrito'
  },
  plans: {
    plan7: 'Plan 7 comidas',
  ...
  addProductMessage: 'Se agregarán los productos al carrito de compras',
  selectProducts: {
    ok: 'agregar',
    nok: 'salir'
  }
